"""Rebuild clustering + summaries from v2 embeddings.

Input:  parallel_data_v2.tsv, emb_openai_v2.npy
...
def main():
    df = pd.read_csv(os.path.join(ROOT, "parallel_data_v2.tsv"), sep="\t", encoding="utf-8")
