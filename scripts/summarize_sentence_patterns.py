...
REPORT_PATH = Path("results/sentence_patterns.md")
...
def main():
    ...
    lines = []
    lines.append("# Sentence-unit marker patterns\n")
    lines.append("\n")
