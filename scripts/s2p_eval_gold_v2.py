...
print(f"  Pred: {len(pred)} rows, {pred['원본문장식별자'].nunique()} 문장")
...
with open('test_results/s2p_eval_gold_v2.json', 'w') as f:
    json.dump(results, f, indent=2)
print(f"\n💾 저장됨: test_results/s2p_eval_gold_v2.json")
